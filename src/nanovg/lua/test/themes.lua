...
local function addSpeareItem(scroll,text)
	...
	layout._colorBG = vg.rgba(0,0,0,128)
...
eventFunction("init",function()
	...
	titleLayout._colorBG = vg.rgba(0,0,0,128)
	...
	addSettingItem(scrollLayout,"双卡管理","images/image1.jpg",function()end)
	addSettingItem(scrollLayout,"WLAN","images/image2.jpg","0450_lejiaolex",function()end)
